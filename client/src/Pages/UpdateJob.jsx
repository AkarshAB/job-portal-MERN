        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
          ...
          <div className="create-job-flex">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              <input type="text" placeholder='Ex: Kochi' defaultValue={jobLocation} {...register("jobLocation")} className='create-job-input' />
            </div>
          </div>
          ...
          <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
              ...
              <input type="date" placeholder='Ex: 13-01-2024' defaultValue={postingDate} {...register("postingDate")} className='create-job-input' />
            </div>
            <div className="lg:w-1/2 w-full">
          ...
          <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
              ...
              <input type="url" placeholder='Ex: Paaste your company logo URL: www.pexels.com/logo' defaultValue={companyLogo} {...register("companyLogo")} className='create-job-input' />
            </div>
            <div className="lg:w-1/2 w-full">
          ...
          <div className='w-full'>
            ...
            <textarea defaultValue={description} {...register("description")} className='w-full pl-3 py-1.5 focus:outline-none placeholder:text-gray-700' rows={6} placeholder={'Job Description'} />
