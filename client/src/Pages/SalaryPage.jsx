...
function SalaryPage() {
  ...
  return (
    <div className='max-w-screen-2xl lg:px-24 container mx-auto px-4'>
      <PageHeader title={'Estimate Salary'} path={'Salary'} />

      <div className='mt-5'>
        <div className='searchBox p-2 text-center mb-2'>
      ...
      {/* salary display card */}
      <div className='grid lg:grid-cols-3  sm:grid-cols-2 grid-cols-1 gap-12 my-12 items-12'>
        {
          salary.map((data) => (
            <div key={data.id} className='shadow px-4 py-8'>
              <h4 className='my-2 font-medium text-blue text-lg'>{data.title}</h4>
              <p>{data.salary}</p>
